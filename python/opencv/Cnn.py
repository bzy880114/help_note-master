...
class Dataset:
    ...
    def load(self, img_rows=40, img_cols=20, img_channels=3, nb_classes=2):
        # 加载数据集到内存

        positive_data_images,positive_data_labels, positive_dirs=self.loadImage('number')
        negative_data_images,negative_data_labels, negative_dirs=self.loadImage('number')
        ...
        if K.image_dim_ordering() == 'th':
            # train_images = train_images.reshape(     .shape[0], img_channels, img_rows, img_cols)
